...
const RegistrarPagoModal = ({ prestamos, onClose, onPagoRegistrado }) => {
  ...
  // Cuando se selecciona un préstamo
  useEffect(() => {
  ...
  // Calcular atraso y mora cuando cambia la fecha o el préstamo
  useEffect(() => {
    if (prestamoSeleccionado && formData.fechaPago) {
      ...
      // Actualizar monto sugerido en modo automático
          ...
          <div className={`relative rounded-2xl shadow-2xl overflow-hidden border-2 border-red-600/30 ${
            ...
            <div className="p-6 max-h-[calc(90vh-120px)] overflow-y-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* Columna Derecha - Distribución y Resumen */}
